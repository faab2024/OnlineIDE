    ...
    <body>
        ...
        <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:246px;" id="mySidebar"><br>
            ...
            <div class="w3-bar-block">
                ...
                <a href="/engineer/home/demo.php" class="w3-bar-item w3-button w3-padding">Your Ongoing Projects</a>
                <a href="/engineer/home/order.php" class="w3-bar-item w3-button w3-padding">Start A New Project</a>
                 <a href="/engineer/home/demo.php" class="w3-bar-item w3-button w3-padding">Completed Projects</a>
                  <a href="/engineer/home/society.php" class="w3-bar-item w3-button w3-padding">Creation Society</a>
                   <a href="/engineer/home/production.php" class="w3-bar-item w3-button w3-padding">Production</a>
                    <a href="https://ice.regrowup.com/production/ide/index.php" class="w3-bar-item w3-button w3-padding">IDE</a>
                <a href="/engineer/log/logout.php" class="w3-bar-item w3-button w3-padding">Sign Out</a>
            </div>
        </nav>
