...
if (!$conn) {
    ...
    $sql="INSERT INTO people(name,phone,email,location) VALUES('$name','$phone','$email','$location')";
   $result=mysqli_query($conn, $sql);
	if ($result != null) {
          ...
          $subject = "ReGrowUp System";
          $message = "Thanks For Registering Your Self As Regrowup Technology Client";
          //"Dear,"+$name+"Thanks For Registering Your Self As Regrowup Technology Client, Your Account Details Are the Follwing"+"Your Name:"+$name+",Your Email:"+$email+",Your Phone:"+$phone+",Your Location:"+$location;
...
<body>    
    ...
    <form action=""  name="signup" method="post" >
         <?PHP echo $reg; ?>
      <header><h3>Signup For OTP Demo </h3></header>
    ...
    <a href="login.php">If You Have Been Registered, Now Go To Login</a>
   </form>
