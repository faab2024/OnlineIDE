    ...
    <body>
        ...
        <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:246px;" id="mySidebar"><br>
            ...
            <div class="w3-bar-block">
                ...
                <a href="http://www.regrowup.com/ibe/production/dgm/index.html" class="w3-bar-item w3-button w3-padding">Draw</a>
               
               
                <a href="https://www.draw.io/" class="w3-bar-item w3-button w3-padding">Diagram</a>
            </div>
        </nav>
