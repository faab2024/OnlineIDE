...
if (!$conn) {
    die("Connection failed: ".mysqli_connect_error());
          ...
          $sql="INSERT INTO creator(name,username,phone,password) VALUES('$name','$username','$phone','$pass')";
...
$subject = "ICE System, Member Registeration Details";
$message = "This Is your Username: ".$username." and This Is Your Password: ".$pass;
$headers = "From: system-ice@regrowup.com";
